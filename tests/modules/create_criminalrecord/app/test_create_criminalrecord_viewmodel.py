from src.modules.create_criminalrecord.app.create_criminalrecord_viewmodel import CreateCriminalRecordViewmodel
...
class Test_CreateCriminalRecordViewmodel:
    def test_create_criminalrecord_viewmodel(self):
        ...
        criminalrecord_viewmodel = CreateCriminalRecordViewmodel(criminalrecord).to_dict()
