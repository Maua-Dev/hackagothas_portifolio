...
from src.modules.get_criminalrecord.app.get_criminalrecord_viewmodel import (
    GetCriminalRecordViewmodel,
)
...
class GetCriminalRecordController:
    ...
    def __call__(self, request: HttpRequest) -> HttpResponse:
        try:
            ...
            criminalrecord = self.GetCriminalRecordUsecase(
                criminalrecord_id=request.data.get("id_criminalrecord")
            )
